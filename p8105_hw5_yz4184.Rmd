...
The data in control_arm group  changed over the time but it is approximately stable. The data in experimental_arm group has a obvious increasing trend.
...
replace_missing = function(vector){
  ...
  vector = ifelse(is.na(vector),"viginica",vector)
  }
  return(vector)
}
